...
public:
	...
	Bullet * makeBullet(SDL_Renderer* renderer, float xPos, float yPos, double angle, double xOffset, double yOffset) { return factory->CreateBullet(renderer,xPos,yPos,angle,xOffset,yOffset); }
